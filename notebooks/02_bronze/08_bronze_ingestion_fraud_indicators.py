...
# ///
# MAGIC %md
# MAGIC # 08 — Bronze Ingestion: Fraud Indicators
...
DATASET_NAME = "fraud_indicators"
RAW_PATH = f"{RAW_BASE_PATH}/fraud_indicators"
BRONZE_TABLE = f"{CATALOG_NAME}.{BRONZE_SCHEMA}.bronze_fraud_indicators"
